...
const updateSite = async (id, companyId, siteData) => {
  ...
  if (siteData.contact_name !== undefined)
    data.contactName = siteData.contact_name;
  if (siteData.contact_email !== undefined)
    data.contactEmail = siteData.contact_email;
  if (siteData.contact_phone !== undefined)
    data.contactPhone = siteData.contact_phone;
  if (siteData.access_code !== undefined)
    data.accessCode = siteData.access_code;
