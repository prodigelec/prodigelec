...
const createQuote = async (quoteData) => {
    ...
    const quote = await prisma.quote.create({
        data: {
            ...
            issuedAt: mainQuoteData.issued_at ? new Date(mainQuoteData.issued_at) : new Date(),
            validUntil: mainQuoteData.valid_until ? new Date(mainQuoteData.valid_until) : null,
...
const updateQuote = async (id, quoteData) => {
    ...
    if (mainQuoteData.total_ht !== undefined) data.totalHt = mainQuoteData.total_ht;
    if (mainQuoteData.tva_rate !== undefined) data.tvaRate = mainQuoteData.tva_rate;
    if (mainQuoteData.total_tva !== undefined) data.totalTva = mainQuoteData.total_tva;
    if (mainQuoteData.total_ttc !== undefined) data.totalTtc = mainQuoteData.total_ttc;
    if (mainQuoteData.issued_at !== undefined) data.issuedAt = mainQuoteData.issued_at ? new Date(mainQuoteData.issued_at) : null;
    if (mainQuoteData.valid_until !== undefined) data.validUntil = mainQuoteData.valid_until ? new Date(mainQuoteData.valid_until) : null;
    if (mainQuoteData.intervention_address !== undefined) data.interventionAddress = mainQuoteData.intervention_address;
    if (mainQuoteData.intervention_city !== undefined) data.interventionCity = mainQuoteData.intervention_city;
    if (mainQuoteData.intervention_zip_code !== undefined) data.interventionZipCode = mainQuoteData.intervention_zip_code;
    if (mainQuoteData.intervention_contact !== undefined) data.interventionContact = mainQuoteData.intervention_contact;
...
const updateQuoteStatus = async (id, companyId, status, additionalData = {}) => {
    ...
    if (additionalData.signed_at !== undefined) data.signedAt = additionalData.signed_at ? new Date(additionalData.signed_at) : null;
    if (additionalData.signature_id !== undefined) data.signatureId = additionalData.signature_id;
    if (additionalData.signature_data !== undefined) data.signatureData = additionalData.signature_data;
    if (additionalData.signer_name !== undefined) data.signerName = additionalData.signer_name;
    if (additionalData.signer_ip !== undefined) data.signerIp = additionalData.signer_ip;
    if (additionalData.signing_metadata !== undefined) data.signingMetadata = additionalData.signing_metadata;
