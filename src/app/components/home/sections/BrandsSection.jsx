                        ...
                        <div className="relative flex overflow-hidden">
                            ...
                            >
                                ...
                                {[...cat.brands, ...cat.brands, ...cat.brands, ...cat.brands].map((brand, bIdx) => (
                                    <span
                                        key={bIdx}
                                        className="text-xl md:text-2xl lg:text-4xl font-black text-white/15 hover:text-white transition-all duration-500 cursor-default uppercase italic tracking-tighter"
                                    >
                                        {brand}
                                    </span>
                                ))}
