        ...
        {activeModal && (
          ...
          >
            <motion.div 
              ...
              className={`bg-[#1a1a1a] border rounded-3xl p-6 md:p-8 max-w-2xl w-full max-h-[85vh] overflow-y-auto relative ${
                activeModal === 'free' ? 'border-primary/20' : 'border-accent/20'
              }`}
            ...
            >
              ...
              <div className="mb-8">
                <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full font-bold text-xs uppercase tracking-wider mb-4 ${
                  activeModal === 'free' ? 'bg-green-500/20 text-green-500' : 'bg-accent/20 text-accent'
                }`}>
              ...
              <div className="space-y-8">
                ...
                <div>
                   <h4 className={`text-lg font-bold mb-4 flex items-center gap-2 ${
                     activeModal === 'free' ? 'text-primary' : 'text-accent'
                   }`}>
