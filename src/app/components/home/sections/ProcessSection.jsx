...
const steps = [
  ...
  },
  {
    ...
    description: "Je me déplace pour établir votre devis. Devis gratuit jusqu'à 30km — Zone 1 (< 5km) : 20€ de déplacement. Au-delà de 30km, des frais s'appliquent. Devis envoyé par email.",
    color: "text-accent",
    ring: "ring-accent/40",
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="relative mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <div className={`absolute inset-0 rounded-full blur-xl opacity-70 bg-linear-to-br ${step.glow}`} />
                  <div className={`w-12 h-12 md:w-16 md:h-16 rounded-full bg-linear-to-b from-white/15 via-white/5 to-black/30 border border-white/15 ring-1 ${step.ring} flex items-center justify-center shadow-[inset_0_1px_2px_rgba(255,255,255,0.25),0_10px_30px_rgba(0,0,0,0.45)] relative`}>
