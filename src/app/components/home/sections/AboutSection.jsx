        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              ...
              <p>
                Aujourd&apos;hui, j&apos;interviens en <strong className="text-primary font-bold">Eure (27) et Eure-et-Loir (28)</strong> avec <BrandName />. Fort de ces années d&apos;expérience, je poursuis cette tradition familiale avec la même exigence et le même savoir-faire qui ont fait nos succès.
              </p>
            </div>
