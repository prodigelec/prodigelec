  ...
  return (
    <div className="flex flex-col gap-6 w-full h-full min-h-[600px]">
      ...
      <div className="bg-[#0b1a2a]/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl relative z-0">
        <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest mb-3 ml-1 flex items-center gap-2">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <div className="relative flex-1">
            ...
            {suggestions.length > 0 && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-[#0d1f32] border border-white/10 rounded-2xl overflow-hidden shadow-2xl animate-in fade-in slide-in-from-top-2 z-50">
        ...
        {result && (
          <div className="mt-4 p-4 rounded-2xl bg-primary/10 border border-primary/20 flex flex-col gap-3 animate-in fade-in slide-in-from-top-2">
            ...
            {result.price.includes('*') && (
               <div className="text-[10px] text-gray-300 italic text-center border-t border-white/5 pt-2">
      ...
      {/* Map Implementation */}
      <div className="relative flex-1 rounded-3xl overflow-hidden border border-white/10 shadow-2xl group z-0">
