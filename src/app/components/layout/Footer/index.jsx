...
export default function Footer() {
  return (
    <footer data-public-footer className="bg-background border-t border-white/5 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/auth/crm-login" className="text-gray-500 hover:text-gray-300 text-xs transition-colors">Espace Pro</Link>
          </div>
        </div>
      </div>
    </footer>
