  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-24">
      ...
      >
        ...
        <div className="text-gray-300 space-y-4 leading-relaxed text-sm md:text-lg">
          <p>
      ...
      >
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
          ...
          <p className="text-gray-400 text-xs md:text-sm">23 ans d&apos;expérience terrain en électricité et serrurerie.</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
          ...
          <p className="text-gray-400 text-xs md:text-sm">Dépannage, mise aux normes et installations sécurisées.</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
          ...
          <p className="text-gray-400 text-xs md:text-sm">CAP Électrotechnique et assurances décennales à jour.</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
          ...
          <p className="text-gray-400 text-xs md:text-sm">Un interlocuteur unique pour vos besoins en électricité et serrurerie.</p>
        </div>
      </motion.div>
    </div>
  );
