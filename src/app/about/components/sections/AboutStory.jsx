    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-24">
      ...
      >
        ...
        <div className="text-gray-100 space-y-4 leading-relaxed text-sm md:text-lg">
          ...
          <p>
            Aujourd&apos;hui, fort de ces années d&apos;expérience, j&apos;interviens en <strong className="text-primary">Eure (27), Eure-et-Loir (28) et dans une partie des Yvelines (78)</strong> avec <BrandName />. Je poursuis cette tradition familiale avec la même exigence et le même savoir-faire qui ont fait nos succès.
          </p>
      ...
      >
        ...
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
          ...
          <p className="text-gray-100 text-xs md:text-sm">Dépannage, mise aux normes et installations sécurisées.</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
          ...
          <p className="text-gray-100 text-xs md:text-sm">CAP Électrotechnique et assurances décennales à jour.</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl">
