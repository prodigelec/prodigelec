        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            ...
            <p className="text-xl text-gray-300 mb-4">
              Je me déplace rapidement sur <span className="font-bold text-primary">Chartres, Broué, Dreux, Anet, Nonancourt, Nogent-le-Roi, Evreux</span> & leurs alentours. Tarifs annoncés avant intervention, pas de surprise.
            </p>
            <div className="flex flex-wrap gap-3 mb-10">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <span className="text-gray-300 font-medium text-sm whitespace-nowrap">Samedi : Sur RDV</span>
              </div>
              <div className="bg-primary/20 backdrop-blur-md border border-primary/30 rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <span className="text-primary font-black text-sm whitespace-nowrap uppercase tracking-tight">Urgence : 19h+</span>
              </div>
            </div>
            <br />
            <a href="tel:0638194752" className="inline-flex items-center gap-2 px-10 py-5 bg-primary text-background rounded-full font-black hover:bg-primary-light transition-all hover:scale-105 shadow-[0_10px_20px_-5px_rgba(201,162,39,0.4)] text-xl">
