...
export default function SerrurerieFAQ() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Oui, en partenariat avec l'Atelier des Frères d'Antan, je propose la reproduction de clés toutes marques ainsi que la copie de badges d'immeuble. Le service est rapide et les clés sont garanties."
        },
        {
