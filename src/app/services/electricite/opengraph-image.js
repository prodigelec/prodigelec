...
export default function OgImage() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: "6px", background: "linear-gradient(180deg, #ffc107 0%, #ffd60a 100%)", display: "flex" }} />
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "200px", background: "linear-gradient(180deg, rgba(255,193,7,0.1) 0%, transparent 100%)", display: "flex" }} />
        ...
        <div style={{ color: "white", fontSize: "70px", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-1.5px", marginBottom: "18px" }}>
          Électricité<br />Générale
        </div>

        <div style={{ color: "rgba(255,255,255,0.55)", fontSize: "23px", lineHeight: 1.45, maxWidth: "820px", marginBottom: "auto" }}>
          Dépannage, mise aux normes NF C 15-100, éclairage LED, chauffage &amp; VMC. Devis gratuit jusqu&apos;à 30 km.
        </div>
