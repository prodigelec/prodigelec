        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            ...
            <p className="text-xl text-gray-300 mb-4">
              Je me déplace rapidement sur <span className="font-bold text-accent">Chartres, Broué, Dreux, Anet, Nonancourt, Nogent-le-Roi, Evreux</span> & leurs alentours. Diagnostic immédiat et réparation sécurisée.
            </p>
            <div className="flex flex-wrap gap-3 mb-10">
              ...
              <div className="bg-accent/20 backdrop-blur-md border border-accent/30 rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <span className="text-accent font-black text-sm whitespace-nowrap uppercase tracking-tight">Urgence : 19h+</span>
              </div>
            </div>
            <br />
            <a href="tel:0638194752" className="inline-flex items-center gap-2 px-10 py-5 bg-accent text-background rounded-full font-black hover:bg-accent-glow transition-all hover:scale-105 shadow-[0_10px_20px_-5px_rgba(var(--color-accent-rgb),0.4)] text-xl">
