  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ color: "white", fontSize: "58px", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-1.5px", marginBottom: "18px" }}>
          Automatismes &amp;<br />Motorisations
        </div>

        <div style={{ color: "rgba(255,255,255,0.55)", fontSize: "23px", lineHeight: 1.45, maxWidth: "820px", marginBottom: "auto" }}>
          Volets motorisés, portails automatiques, portes de garage. Domotique Somfy avec pilotage smartphone.
        </div>
