                        ...
                        <div className="relative flex overflow-hidden">
                            ...
                            >
                                ...
                                {[...cat.brands, ...cat.brands, ...cat.brands, ...cat.brands].map((brand, bIdx) => (
                                    <span
                                        key={bIdx}
                                        className="text-xl md:text-2xl lg:text-4xl font-black text-white/[0.15] hover:text-white hover:scale-105 transition-all duration-500 cursor-default uppercase italic tracking-tighter"
                                    >
                                        {brand}
                                    </span>
                                ))}
