              ...
              {loading ? (
                Array.from({ length: 3 }).map((_, i) => (
                  <tr key={i} className="animate-pulse">
                    <td
                      colSpan="5"
                      className="px-6 py-4 bg-slate-50/20 h-16"
                    ></td>
                  </tr>
                ))
                  ...
                  >
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-slate-400">
                        {new Date(quote.issued_at).toLocaleDateString()}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="font-bold text-slate-900">
                        {quote.total_ttc.toLocaleString()} €
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusStyles(quote.status)}`}
                      >
                        {statusOptions.find((o) => o.value === quote.status)
                          ?.label || quote.status}
                      </span>
                    </td>
