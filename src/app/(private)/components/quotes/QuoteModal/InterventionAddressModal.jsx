...
export default function InterventionAddressModal({
  isOpen,
  onClose,
  onSave,
  initialAddress,
  ...
  // Initialize state directly from props - component will re-mount when key changes
      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl flex flex-col animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
          <p className="text-sm text-slate-500">
            Renseignez l&apos;adresse où les travaux seront effectués si elle diffère
            de l&apos;adresse du client.
          </p>

          <div className="space-y-2">
            <label className="block text-xs font-bold text-slate-500 uppercase">
              Nom du contact / Résident (Optionnel)
            </label>
