          ...
          <div className="bg-slate-50 rounded-xl p-4 text-sm text-slate-600">
            <p>
              {selectedType === "individual" && (
                <>
                  👤 <strong>Particulier</strong> : Devis simplifié avec
                  nom/prénom et coordonnées.
                </>
              )}
              {selectedType === "professional" && (
                <>
                  🏢 <strong>Professionnel</strong> : Devis avec SIRET, TVA
                  intracommunautaire et conditions de paiement.
                </>
              )}
              {selectedType === "syndic" && (
                <>
                  🏛️ <strong>Syndic</strong> : Devis avec adresse de facturation
                  (syndic) et adresse d&apos;intervention (immeuble).
                </>
              )}
            </p>
          </div>
