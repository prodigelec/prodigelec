  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!hasLastName && !hasCompanyName) {
        toast.error(
          "Un nom (particulier) ou une raison sociale (société) est obligatoire",
        );
        setIsLoading(false);
        return;
      }
      ...
      if (
        ...
        toast.error(
          "La raison sociale est obligatoire pour une société ou un syndic",
        );
        setIsLoading(false);
        return;
      }
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {formData.type === "professional" && (
                    <p className="text-xs text-slate-500">
                      Si votre société n&apos;apparaît pas (statut
                      non-diffusible), saisissez le nom manuellement.
                    </p>
                  )}
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-4 pt-2 border-t border-slate-100">
            ...
            <div className="space-y-2 pt-2">
              <label className="text-sm font-medium text-slate-700">
                {formData.type === "syndic"
                  ? "Adresse de l'immeuble (Chantier)"
              ...
              <AddressAutocomplete
                ...
                onSelect={(data) =>
                  setFormData((prev) => ({
                    ...
                    delivery_zip_code: data.zip_code,
                    delivery_city: data.city,
                  }))
                }
                placeholder={
                  formData.type === "syndic"
                    ? "Adresse où l'intervention a lieu..."
                    : "Adresse de chantier..."
                }
                className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none"
              />
          ...
          <div className="space-y-2 pt-2 border-t border-slate-100">
            <h3 className="text-sm font-semibold text-slate-900 flex items-center gap-2">
              <FileText size={16} className="text-slate-400" /> Autres
              informations
            </h3>
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700">
            ...
            <div className="space-y-4 pt-2 border-t border-slate-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <label className="text-sm font-medium text-slate-700 block pt-2">
                    Alertes / Notes
                  </label>
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      const tagColors = {
                        ...
                        "Mauvais Payeur":
                          "bg-(--color-danger-soft) border-(--color-danger)/30 text-(--color-danger)",
                        "Facture à réclamer":
                          "bg-(--color-info-soft) border-(--color-info)/30 text-(--color-info)",
                        "Accès Spécifique":
                          "bg-(--color-primary-soft) border-(--color-primary)/30 text-(--color-primary)",
                        "Client Difficile":
