        ...
        <div className="bg-slate-50 px-8 py-6 border-b border-slate-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Configurons ensemble votre identité commerciale.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <div
              className={`h-2 w-2 rounded-full ${step >= 1 ? "bg-primary" : "bg-slate-200"}`}
            />
            <div
              className={`h-2 w-2 rounded-full ${step >= 2 ? "bg-primary" : "bg-slate-200"}`}
            />
            <div
              className={`h-2 w-2 rounded-full ${step >= 3 ? "bg-primary" : "bg-slate-200"}`}
            />
          </div>
        </div>
