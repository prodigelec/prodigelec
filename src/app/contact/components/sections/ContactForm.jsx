...
export default function ContactForm() {
  ...
  return (
    ...
    >
      {/* Left Side - Context */}
      <div className="lg:col-span-2 bg-gradient-to-br from-slate-900 to-slate-800 p-10 flex flex-col justify-between relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label htmlFor="name" className="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Nom complet</label>
              <input 
                type="text" 
                id="name" 
                required
            ...
            <div className="space-y-1">
              <label htmlFor="phone" className="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Téléphone</label>
              <input 
                type="tel" 
                id="phone" 
                required
          ...
          <div className="space-y-1">
            <label htmlFor="email" className="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Email</label>
            <input 
              type="email" 
              id="email" 
              required
          ...
          <button 
            type="submit"
            className="w-full bg-gradient-to-r from-primary to-blue-500 text-white font-bold text-base py-3 rounded-xl hover:shadow-lg hover:shadow-primary/25 hover:scale-[1.01] transition-all flex items-center justify-center gap-2 group"
          >
