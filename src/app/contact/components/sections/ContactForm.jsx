    ...
    >
      ...
      <div className="lg:col-span-2 bg-linear-to-br from-slate-900 to-slate-800 p-6 md:p-10 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 mt-12">
          <div className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-2 group"><BrandName className="text-[10px]" /></div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label htmlFor="user_name" className="text-xs font-bold text-gray-300 uppercase tracking-wide ml-1">Nom complet</label>
              <input
                type="text"
                name="user_name"
                id="user_name"
                required
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all"
              />
            </div>
            <div className="space-y-1">
              <label htmlFor="user_phone" className="text-xs font-bold text-gray-300 uppercase tracking-wide ml-1">Téléphone</label>
              <input
                type="tel"
                name="user_phone"
                id="user_phone"
            ...
            <div className="space-y-1">
              <label htmlFor="user_email" className="text-xs font-bold text-gray-300 uppercase tracking-wide ml-1">Email</label>
              <input
                type="email"
                name="user_email"
                id="user_email"
            ...
            <div className="space-y-1">
              <label htmlFor="user_city" className="text-xs font-bold text-gray-300 uppercase tracking-wide ml-1">Ville</label>
              <input
                type="text"
                name="user_city"
                id="user_city"
          ...
          <div className="space-y-1">
            <label htmlFor="service" className="text-xs font-bold text-gray-300 uppercase tracking-wide ml-1">Service concerné</label>
            <select
              name="service"
              id="service"
          ...
          <div className="space-y-1">
            <label htmlFor="message" className="text-xs font-bold text-gray-300 uppercase tracking-wide ml-1">Votre message</label>
            <textarea
              name="message"
              id="message"
              required
              rows={3}
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all resize-none"
