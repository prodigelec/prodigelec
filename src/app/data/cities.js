export const cities = [
  ...
  },
  {
    ...
    distance: 10,
    freeZone: true,
    nearby: ["Nogent-le-Roi", "Bû", "Boutigny-Prouais", "Broué"],
    photo: "/tableau-electrique-cuisine-faverolles.jpg",
    photoAlt: "Tableau électrique Hager remplacé et entièrement repéré par PRODIGELEC dans une maison de Faverolles, Eure-et-Loir",
    description: "Faverolles est une commune du canton de Nogent-le-Roi que j'atteins en une dizaine de minutes depuis Broué. J'y ai remplacé le tableau électrique complet d'une maison et repris toute l'alimentation de sa cuisine, circuit par circuit, aux normes NF C 15-100. Électricité, sécurité et automatismes — déplacement gratuit pour le devis.",
    localContext: "Village rural du 28210 entre Nogent-le-Roi et Bû — pavillons et longères équipés de tableaux souvent d'origine, avec des besoins en remise aux normes, en circuits dédiés pour la cuisine et en motorisation de portail.",
  },
  {
    slug: "abondant",
    name: "Abondant",
  ...
  },
  {
    ...
    distance: 18,
    freeZone: true,
    nearby: ["Ézy-sur-Eure", "Ivry-la-Bataille", "Anet", "Marcilly-sur-Eure"],
    photo: "/depannage-portail-nice-l-habit.jpg",
    photoAlt: "Motorisation de portail Nice dépannée par PRODIGELEC à L'Habit, Eure",
    description: "L'Habit est un village de l'Eure voisin d'Ézy-sur-Eure, que je rejoins depuis Broué en une vingtaine de minutes. J'y ai remis en service un portail motorisé Nice qui ne répondait plus, après une recherche de panne sur son armoire de commande. Électricité, sécurité et automatismes — déplacement gratuit pour le devis, sans engagement.",
    localContext: "Village rural de la vallée de l'Eure entre Ézy-sur-Eure et Ivry-la-Bataille — maisons et propriétés avec portails motorisés, installations électriques anciennes et besoins en sécurisation des accès.",
  },
  {
    slug: "tilly",
    name: "Tilly",
