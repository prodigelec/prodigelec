...
const features = [
  {
    ...
    description:
      "Toutes mes interventions respectent strictement les normes de sécurité en vigueur pour votre protection.",
  ...
  },
  {
    ...
    description:
      "Je m'engage à laisser votre domicile aussi propre qu'à mon arrivée. Pas de poussière, pas de traces.",
  ...
  },
  {
    ...
    title: "Zéro Surprise",
    description:
      "Le prix du devis est ferme et définitif. Aucune facturation supplémentaire imprévue en fin de chantier.",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`mb-6 inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.gradient} ring-1 ring-white/20 shadow-[inset_0_1px_2px_rgba(255,255,255,0.35)] group-hover:scale-110 transition-transform duration-300`}
              >
                {feature.icon}
              </div>
