...
const steps = [
  {
    ...
    description:
      "Vous m&apos;appelez ou m&apos;envoyez un email. On discute de votre besoin et je vous donne une première estimation ou un rendez-vous.",
    color: "text-primary",
  ...
  },
  {
    ...
    description:
      "Je me déplace (gratuit < 5km). Devis clair envoyé par email avec signature électronique sécurisée pour un accord rapide.",
    color: "text-accent",
    ring: "ring-accent/40",
  ...
  },
  {
    ...
    title: "Intervention",
    description:
      "Une fois le devis validé, je réalise les travaux avec soin, en respectant les normes de sécurité et votre domicile.",
  ...
  },
  {
    ...
    description:
      "Signature devis en ligne, facturation numérique et paiement sécurisé (CB, lien de paiement, virement). Garantie décennale incluse.",
    color: "text-success",
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="relative mb-6 group-hover:scale-110 transition-transform duration-300">
                  <div
                    className={`absolute inset-0 rounded-full blur-xl opacity-70 bg-gradient-to-br ${step.glow}`}
                  />
                  <div
                    className={`w-16 h-16 rounded-full bg-gradient-to-b from-white/15 via-white/5 to-black/30 border border-white/15 ring-1 ${step.ring} flex items-center justify-center shadow-[inset_0_1px_2px_rgba(255,255,255,0.25),0_10px_30px_rgba(0,0,0,0.45)] relative`}
                  >
