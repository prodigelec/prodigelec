          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-400 leading-relaxed max-w-md">
                Recevez nos astuces techniques pour sécuriser votre habitat et
                profitez de remises saisonnières réservées à nos abonnés.
              </p>
            </motion.div>
              ...
              <form onSubmit={handleSubmit} className="relative group/form">
                ...
                <div className="relative bg-background/50 border border-white/10 p-2 rounded-2xl flex flex-col md:flex-row gap-2">
                  ...
                  <button
                    ...
                    className={`relative overflow-hidden px-8 py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 min-w-[180px] ${
                      status === "success"
                  ...
                  >
                    {(status === "idle" || status === "error") && (
                      <>
                        <span>
                          {status === "error" ? "Réessayer" : "S'abonner"}
                        </span>
                        <Send
                          className={`w-5 h-5 transition-transform ${agreedToGdpr ? "group-hover:translate-x-1 group-hover:-translate-y-1" : ""}`}
                        />
                      </>
                    )}
                    {status === "loading" && (
                ...
                <div className="mt-4 flex items-start gap-3 px-2">
                  ...
                  >
                    J&apos;accepte de recevoir vos conseils techniques et offres
                    commerciales par e-mail. Vous pouvez vous désinscrire à tout
                    moment. Voir notre{" "}
                    <a
                ...
                {status === "error" && (
                  ...
                  >
                    <div className="w-4 h-4 rounded-full bg-error flex items-center justify-center text-[10px] font-bold">
                      !
                    </div>
                    {errorMessage}
                  </motion.p>
