            ...
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <View style={styles.logoPlaceholder}>
                        ...
                        <Text style={{ color: '#0b1a2a', fontSize: 16, fontWeight: 'bold' }}>PRODIGELEC</Text>
                        <Text style={{ color: '#c9a227', fontSize: 8 }}>Expertise Technique</Text>
                    </View>
                ...
                <View style={styles.heroCard}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                        <View>
                            <Text style={{ fontSize: 10, color: '#4b5563' }}>Intervention rapide Lun-Ven</Text>
                            <Text style={{ fontSize: 10, color: '#4b5563' }}>Eure (27) & Eure-et-Loir (28)</Text>
                        </View>
                ...
                <View style={styles.zonesContainer}>
                    ...
                    <View style={styles.zonesList}>
                        {["Broué", "Dreux", "Chartres", "Évreux", "Anet", "Nonancourt", "St-André"].map((city) => (
                ...
                <View style={styles.footer}>
                    <View style={styles.contactInfo}>
                        ...
                        <View>
                            <Text style={styles.footerLegal}>SIRET : 80430489700023 • Décennale</Text>
