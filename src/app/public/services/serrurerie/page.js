...
export const metadata = {
  ...
  description:
    "Serrurier urgence à Broué, Dreux, Chartres. Ouverture de porte, changement de serrure 3 points, volets roulants, reproduction de clés. Disponible 6j/7.",
  keywords: [
    "Serrurier Broué",
    "Serrurier Dreux",
    "Serrurier Chartres",
  ...
  openGraph: {
    ...
    description:
      "Ouverture de porte, changement de serrure et sécurisation. Intervention rapide sur Broué, Dreux et Chartres.",
